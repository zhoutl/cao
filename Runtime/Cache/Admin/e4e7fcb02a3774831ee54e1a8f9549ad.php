...
<body>
    ...
    <div class="cf">
        <a class="btn" href="<?php echo U('style_add');?>">新 增</a>
        <button class="btn ajax-post confirm" url="<?php echo U('style_del');?>" target-form="ids">删 除</button>
        <!-- 高级搜索 -->
        <div class="search-form fr cf">
            <div class="sleft">
                <input type="text" name="title" class="search-input" value="<?php echo I('title');?>" placeholder="请输入菜单名称">
                <a class="sch-btn" href="javascript:;" id="search" url="/cao/index.php?s=/admin/item/style_index.html"><i class="btn-search"></i></a>
            </div>
        </div>
    </div>
    ...
    <div class="data-table table-striped">
        <form class="ids">
            <table>
                ...
                <tbody>
                <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$category): $mod = ($i % 2 );++$i;?><tr>
                            <td><input class="ids row-selected" type="checkbox" name="id[]" value="<?php echo ($category["id"]); ?>"></td>
                            <td><?php echo ($category["id"]); ?></td>
                            <td><?php echo ($category["title"]); ?></td>
                            <td>
                                <a title="编辑" href="<?php echo U('style_edit?id='.$category['id']);?>">编辑</a>
                                <a class="confirm ajax-get" title="删除" href="<?php echo U('style_del?id='.$category['id']);?>">删除</a>
                            </td>
