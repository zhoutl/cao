...
<body>
    ...
    <div class="main-title">
        <h2><?php if(isset($data)): ?>商品详情<?php endif; ?></h2>
    </div>
                    ...
                    <div class="sys-info">
                        <table>
                            ...
                            <tr>
                                <th>图片</th>
                                <td>
                                    <?php if(is_array($picture)): $i = 0; $__LIST__ = $picture;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$picture): $mod = ($i % 2 );++$i;?><img style="height: 200px;width: 200px ; padding:0.4cm; " src="/cao<?php echo ($picture['path']); ?>" data-id="<?php echo ($picture['id']); ?>" width="200px" height="200px"/><?php endforeach; endif; else: echo "" ;endif; ?>
                                </td>
                            </tr>
                            <tr>
                                <th>详细信息</th>
                                <td>
                                    <div class="span9 main-content">
                                        <!-- Contents
                                        ================================================== -->
                                        <section id="description"><?php echo ($data["description"]); ?></section>
                                    </div>
                                </td>
                            </tr>
                        </table>
